...
as its parameters for student B. Create an object for each of the two classes and
...
public static void main(String[] args){
 ...
 double p1 = a.getPercentage(); //object of class A calling its
getPercentage() function
 double p2 = b.getPercentage(); //object of class B calling its
getPercentage() function
